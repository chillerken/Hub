...
</style></head><body><div class="w"><div class="top"><div><div class="brand">LUXWASH AI OS</div><div id="stamp" class="stamp">Live bedrijfscockpit</div></div><div class="topBtns"><button class="b refresh" onclick="load()">↻ Vernieuw</button><a class="b" href="/logout">Uitloggen</a></div></div><div id="backendBanner"></div><div class="tabs"><button class="tab on" data-x="overview">Overzicht</button><button class="tab" data-x="luxwash">🧽 LuxWash</button><button class="tab" data-x="saas">💰 AI SaaS</button><button class="tab" data-x="personal">🧠 Persoonlijk</button><button class="tab" data-x="fitness">🏋️ Fitness</button><button class="tab" data-x="dj">🎧 DJ</button></div>
...
<section id="dj" class="sec"><div class="p"><h2>DJ Ferocious</h2><p class="small">Trackselectie, setvoorbereiding en oefentaken.</p><div id="djt" class="list"></div></div></section></div>
<script>
